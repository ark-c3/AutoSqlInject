...
#verifica se o sqlmap esta instalado
if [ -e $sqlmap ];then
  echo -e "[@] SQL MAP ENCONTRADO"
  sleep 1
  echo
  clear
else
  echo -e "[!] SQL MAP NÃO ENCONTRADO!"
  sleep 2
  exit
fi
...
echo
echo -ne "\033[01;33mINICIANDO" ; sleep 0.5 ; echo -ne "." ; sleep 0.5 ; echo -ne "." ; sleep 0.5 ; echo -ne "." ; sleep 0.5 ; echo -e " OK!"
echo
sleep 1
